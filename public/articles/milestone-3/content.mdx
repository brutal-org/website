...
This roadmap is not set in stone, and is subject to changes. You might want to check out the [https://github.com/brutal-org/brutal/blob/main/meta/roadmap.md](latest version of the roadmap).
